...
const STRINGS := {
	"en": {
		...
		# --- About panel ---
		"about_tagline": "Multiplayer arcade racing",
		"about_version": "Version",
		"about_build": "Build",
		"about_source": "Source",
		"about_design": "Game design & direction — P.-A. Goya",
		...
		"about_signature": "The whole game crafted by Claude — Opus 4.8",
	},
	"fr": {
		# --- Online menu (static scene text) ---
		"ui_quit": "Quitter",
		...
		# --- Panneau À propos ---
		"about_tagline": "Course arcade multijoueur",
		"about_version": "Version",
		"about_build": "Build",
		...
		"about_signature": "Jeu entièrement façonné par Claude — Opus 4.8",
	},
}
