...
const ROLE_INFO := {
	"start":        { "col": Color(1.0, 0.62, 0.18) },
	"finish":       { "col": Color(0.32, 0.90, 0.42) },
	"start_finish": { "col": Color(0.30, 0.92, 0.82) },
	"checkpoint":   { "col": Color(0.38, 0.62, 0.96) },
}
...
func _role_label() -> String:
	return tr("ed_role_" + get_role()).to_upper()
